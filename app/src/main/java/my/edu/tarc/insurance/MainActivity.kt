...
class MainActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        radioGroupGender.setOnCheckedChangeListener { it, _ ->
            val male = it.checkedRadioButtonId
            ...
            textViewPremium.text = malePremium.toString()
        }//end of radio group
...
/*
        //from radio button determine is it selected
        radioButtonMale.setOnClickListener {
            val male = it.isSelected//it = refer to the view
            if(male){
    ...
    //from radio group determine which one is chosen
